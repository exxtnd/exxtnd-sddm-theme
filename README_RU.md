...
конкретно с фоном, если не хотите лезть в qml, переименуйте заранее свою картинку в ``bg.jpg`` и переместите её в папку assets в директории темы с заменой.
если формат вашей картинки иной, придется менять название/формат фона в коде qml. 

если хотите изменить идущую с темой fallback картинку профиля итд, действуйте по той же аналогии, все пикчи находятся в assets. 
